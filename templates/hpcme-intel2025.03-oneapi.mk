...
NETCDF =             # If value is '3' and CPPDEFS contains
                     ...
                     # the compile command.
INCLUDES := $(shell pkg-config --cflags hdf5_fortran) $(shell nf-config --flibs) $(shell nc-config --cflags) $(shell nf-config --fflags) -I/opt/spack-environment/.spack-env/view/include
...
LIBS := -L/opt/spack-environment/.spack-env/view/lib -lyaml -lhdf5 -lhdf5_hl_fortran -lhdf5_hl -lhdf5_fortran -lnetcdf -lnetcdff
